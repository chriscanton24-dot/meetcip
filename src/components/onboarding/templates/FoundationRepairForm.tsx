...
interface FoundationRepairFormProps {
  formData: any
...
const FoundationRepairForm: React.FC<FoundationRepairFormProps> = ({ formData, setFormData, onSubmit, onBack }) => {
  ...
  const [serviceCallFee, setServiceCallFee] = useState(formData.service_call_fee || '0')
  const [afterHoursFee, setAfterHoursFee] = useState(formData.after_hours_fee || '0')
  const [emergency24x7, setEmergency24x7] = useState(formData.emergency_24x7 ?? false)
  ...
  const handleSubmit = () => {
    ...
    const data = {
      ...
      pricing: {
        service_call: parseInt(serviceCallFee) || 0,
        after_hours: parseInt(afterHoursFee) || 0
      },
  ...
  return (
    <div className="industry-form">
      <div className="form-header">
        ...
        <h2>Foundation Repair Configuration</h2>
        <p className="form-subtitle">
          Tell us about your foundation repair business, and we'll configure your AI to handle calls perfectly.
        </p>
      </div>
      ...
      <div className="form-section">
        ...
        <input
          ...
          placeholder="e.g., ABC Foundation Repair"
          value={businessName}
        ...
        <div className="form-row">
          <div className="form-col">
            ...
            <input
              type="email"
              className="form-input"
              placeholder="e.g., info@abcfoundation.com"
              value={businessEmail}
      ...
      <div className="form-section">
        ...
        <p className="form-hint">Leave as $0 if you provide free inspections/estimates</p>
        <div className="form-row">
          <div className="form-col">
            <label className="form-sublabel">Inspection Fee</label>
          ...
          <div className="form-col">
            <label className="form-sublabel">Assessment Fee</label>
            <div className="input-group">
              <span className="input-prefix">$</span>
              <input
                type="number"
        ...
        {customQA.map((qa, index) => (
          <div key={index} className="qa-pair">
            ...
            <input
              type="text"
              className="form-input"
              placeholder="Question (e.g., How long does foundation repair take?)"
              value={qa.question}
...
export default FoundationRepairForm