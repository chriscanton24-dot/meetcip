...
const FencingForm: React.FC<FencingFormProps> = ({ formData, setFormData, onSubmit, onBack }) => {
  ...
  return (
    <div className="industry-form">
      <div className="form-header">
        ...
        <h2>Fencing Business Configuration</h2>
        <p className="form-subtitle">
          Tell us about your fencing business, and we'll configure your AI to handle calls perfectly.
        </p>
      </div>
      ...
      <div className="form-section">
        ...
        <input
          ...
          placeholder="e.g., ABC Fencing & Gates"
          value={businessName}
        ...
        <div className="form-row">
          <div className="form-col">
            ...
            <input
              type="email"
              className="form-input"
              placeholder="e.g., info@abcfencing.com"
              value={businessEmail}
      ...
      <div className="form-section">
        ...
        <div className="form-row">
          ...
          <div className="form-col">
            <label className="form-sublabel">Emergency Repair Fee</label>
            <div className="input-group">
              <span className="input-prefix">$</span>
              <input
                type="number"
      ...
      <div className="form-section">
        ...
        <label className="toggle-item">
          ...
          />
          <span>Emergency Repair Service Available</span>
        </label>
      </div>
        ...
        {customQA.map((qa, index) => (
          <div key={index} className="qa-pair">
            ...
            <input
              type="text"
              className="form-input"
              placeholder="Question (e.g., Do you install pool fences?)"
              value={qa.question}
