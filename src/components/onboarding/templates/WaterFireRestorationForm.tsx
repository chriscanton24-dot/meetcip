...
interface WaterFireRestorationFormProps {
  formData: any
...
const WaterFireRestorationForm: React.FC<WaterFireRestorationFormProps> = ({ formData, setFormData, onSubmit, onBack }) => {
  ...
  return (
    <div className="industry-form">
      <div className="form-header">
        ...
        <h2>Water/Fire Restoration Configuration</h2>
        <p className="form-subtitle">
          Tell us about your restoration business, and we'll configure your AI to handle emergency calls perfectly.
        </p>
      </div>
      ...
      <div className="form-section">
        ...
        <input
          ...
          placeholder="e.g., ABC Restoration Services"
          value={businessName}
        ...
        <div className="form-row">
          <div className="form-col">
            ...
            <input
              type="email"
              className="form-input"
              placeholder="e.g., info@abcrestoration.com"
              value={businessEmail}
      ...
      <div className="form-section">
        ...
        <p className="form-hint">Leave as $0 if pricing varies by project</p>
        <div className="form-row">
          <div className="form-col">
            <label className="form-sublabel">Initial Assessment Fee</label>
          ...
          <div className="form-col">
            <label className="form-sublabel">Emergency Response Fee</label>
            <div className="input-group">
              <span className="input-prefix">$</span>
              <input
                type="number"
        ...
        {customQA.map((qa, index) => (
          <div key={index} className="qa-pair">
            ...
            <input
              type="text"
              className="form-input"
              placeholder="Question (e.g., Do you work with insurance companies?)"
              value={qa.question}
...
export default WaterFireRestorationForm