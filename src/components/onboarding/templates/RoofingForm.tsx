...
const RoofingForm: React.FC<RoofingFormProps> = ({ formData, setFormData, onSubmit, onBack }) => {
  ...
  return (
    <div className="industry-form">
      <div className="form-header">
        ...
        <h2>Roofing Business Configuration</h2>
        <p className="form-subtitle">
          Tell us about your roofing business, and we'll configure your AI to handle calls perfectly.
        </p>
      </div>
      ...
      <div className="form-section">
        ...
        <input
          ...
          placeholder="e.g., ABC Roofing & Gutters"
          value={businessName}
        ...
        <div className="form-row">
          <div className="form-col">
            ...
            <input
              type="email"
              className="form-input"
              placeholder="e.g., info@abcroofing.com"
              value={businessEmail}
      ...
      <div className="form-section">
        ...
        <div className="form-row">
          ...
          <div className="form-col">
            <label className="form-sublabel">Emergency Service Fee</label>
            <div className="input-group">
              <span className="input-prefix">$</span>
              <input
                type="number"
