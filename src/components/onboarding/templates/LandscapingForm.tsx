...
interface LandscapingFormProps {
  formData: any
...
const LandscapingForm: React.FC<LandscapingFormProps> = ({ formData, setFormData, onSubmit, onBack }) => {
  ...
  return (
    <div className="industry-form">
      <div className="form-header">
        ...
        <h2>Landscaping Business Configuration</h2>
        <p className="form-subtitle">
          Tell us about your landscaping business, and we'll configure your AI to handle calls perfectly.
        </p>
      </div>
      ...
      <div className="form-section">
        ...
        <input
          ...
          placeholder="e.g., ABC Landscaping & Lawn Care"
          value={businessName}
        ...
        <div className="form-row">
          <div className="form-col">
            ...
            <input
              type="email"
              className="form-input"
              placeholder="e.g., info@abclandscaping.com"
              value={businessEmail}
      ...
      <div className="form-section">
        ...
        <p className="form-hint">Leave as $0 if you provide free estimates</p>
        <div className="form-row">
          <div className="form-col">
            <label className="form-sublabel">Consultation Fee</label>
          ...
          <div className="form-col">
            <label className="form-sublabel">Design Fee</label>
            <div className="input-group">
              <span className="input-prefix">$</span>
              <input
                type="number"
      ...
      <div className="form-section">
        ...
        <label className="toggle-item">
          ...
          />
          <span>Emergency Service Available (storm cleanup, etc.)</span>
        </label>
      </div>
        ...
        {customQA.map((qa, index) => (
          <div key={index} className="qa-pair">
            ...
            <input
              type="text"
              className="form-input"
              placeholder="Question (e.g., Do you offer seasonal contracts?)"
              value={qa.question}
