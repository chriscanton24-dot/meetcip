...
const PlumbingForm: React.FC<PlumbingFormProps> = ({ formData, setFormData, onSubmit, onBack }) => {
  ...
  return (
    <div className="industry-form">
      <div className="form-header">
        ...
        <h2>Plumbing Business Configuration</h2>
        <p className="form-subtitle">
          Tell us about your plumbing business, and we'll configure your AI to handle calls perfectly.
        </p>
      </div>
        ...
        {customQA.map((qa, index) => (
          <div key={index} className="qa-pair">
            ...
            <input
              type="text"
              className="form-input"
              placeholder="Question (e.g., Do you offer camera inspection?)"
              value={qa.question}
