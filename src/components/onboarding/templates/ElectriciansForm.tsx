...
interface ElectriciansFormProps {
  formData: any
...
const ElectriciansForm: React.FC<ElectriciansFormProps> = ({ formData, setFormData, onSubmit, onBack }) => {
  ...
  const [serviceCallFee, setServiceCallFee] = useState(formData.service_call_fee || '99')
  const [afterHoursFee, setAfterHoursFee] = useState(formData.after_hours_fee || '150')
  ...
  const handleSubmit = () => {
    ...
    const data = {
      ...
      pricing: {
        service_call: parseInt(serviceCallFee) || 99,
        after_hours: parseInt(afterHoursFee) || 150
      },
  ...
  return (
    <div className="industry-form">
      <div className="form-header">
        ...
        <h2>Electrical Contractor Configuration</h2>
        <p className="form-subtitle">
          Tell us about your electrical business, and we'll configure your AI to handle calls perfectly.
        </p>
      </div>
        ...
        <div className="form-row">
          <div className="form-col">
            ...
            <input
              type="email"
              className="form-input"
              placeholder="e.g., info@abcelectrical.com"
              value={businessEmail}
        ...
        {customQA.map((qa, index) => (
          <div key={index} className="qa-pair">
            ...
            <input
              type="text"
              className="form-input"
              placeholder="Question (e.g., Do you handle permits?)"
              value={qa.question}
