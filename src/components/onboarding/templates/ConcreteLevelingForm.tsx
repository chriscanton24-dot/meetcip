...
interface ConcreteLevelingFormProps {
  formData: any
...
const ConcreteLevelingForm: React.FC<ConcreteLevelingFormProps> = ({ formData, setFormData, onSubmit, onBack }) => {
  ...
  return (
    <div className="industry-form">
      <div className="form-header">
        ...
        <h2>Concrete Leveling Configuration</h2>
        <p className="form-subtitle">
          Tell us about your concrete leveling business, and we'll configure your AI to handle calls perfectly.
        </p>
      </div>
      ...
      <div className="form-section">
        ...
        <input
          ...
          placeholder="e.g., ABC Concrete Leveling"
          value={businessName}
        ...
        <div className="form-row">
          <div className="form-col">
            ...
            <input
              type="email"
              className="form-input"
              placeholder="e.g., info@abcconcrete.com"
              value={businessEmail}
        ...
        {customQA.map((qa, index) => (
          <div key={index} className="qa-pair">
            ...
            <input
              type="text"
              className="form-input"
              placeholder="Question (e.g., How long does leveling last?)"
              value={qa.question}
...
export default ConcreteLevelingForm