...
const HVACForm: React.FC<HVACFormProps> = ({ formData, setFormData, onSubmit, onBack }) => {
  ...
  return (
    <div className="industry-form">
      <div className="form-header">
        ...
        <h2>HVAC Business Configuration</h2>
        <p className="form-subtitle">
          Tell us about your HVAC business, and we'll configure your AI to handle calls perfectly.
        </p>
      </div>
        ...
        <div className="form-row">
          <div className="form-col">
            ...
            <input
              type="email"
              className="form-input"
              placeholder="e.g., info@abchvac.com"
              value={businessEmail}
